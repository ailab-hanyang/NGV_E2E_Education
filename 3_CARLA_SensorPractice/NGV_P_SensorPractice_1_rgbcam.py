#!/usr/bin/env python3
#======================================================================#
# Module:      NGV_SensorPractice_1_rgbcam.py
# Description: Sensor practice - RGB camera visualization (pygame)
#
...
def spawn_ego_vehicle(world, tm_port):
    ...
    ego_blueprint = find_vehicle_bp(world, "vehicle.dodge.charger_2020")
    ego = world.spawn_actor(ego_blueprint, ego_transform)
...
def main():
    ...
    pygame.display.set_caption("NGV | RGB | C:Cam | V:MapTop | Q:Manual | R:Reverse | ESC Quit")
    ...
    try:
        ...
        #-[TODO]- Spawn rgbcam actor on ego_vehicle
        ...
        #-[TODO]- Listen to rgbcam data stream 
        ...
        while True:
            ...
            # spectator follow
            if follow_enabled and spectator and is_alive(ego_vehicle):
