#!/usr/bin/env python3
#======================================================================#
# Module:      NGV_SensorPractice_2_depthcam.py
# Description: Sensor practice - Depth camera visualization (pygame)
#
...
def main():
    ...
    pygame.display.set_caption("NGV | DEPTH | C:Cam | V:MapTop | Q:Manual | R:Reverse | ESC Quit")
