#!/usr/bin/env python3
#======================================================================#
# Module:      NGV_SensorPractice_8_collision.py
# Description: Sensor practice - Collision terminal output
#
...
def main():
    ...
    pygame.display.set_caption("NGV | COLLISION | C:Cam | V:MapTop | Q:Manual | R:Reverse | ESC Quit")
