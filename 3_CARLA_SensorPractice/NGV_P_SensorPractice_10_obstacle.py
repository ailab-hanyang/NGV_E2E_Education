#!/usr/bin/env python3
#======================================================================#
# Module:      NGV_SensorPractice_10_obstacle.py
# Description: Sensor practice - Obstacle sensor terminal output
#
...
def main():
    ...
    pygame.display.set_caption("NGV | OBSTACLE | C:Cam | V:MapTop | Q:Manual | R:Reverse | ESC Quit")
