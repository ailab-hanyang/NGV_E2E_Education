#!/usr/bin/env python3
#======================================================================#
# Module:      NGV_SensorPractice_7_imu.py
# Description: Sensor practice - IMU terminal output
#
...
def main():
    ...
    pygame.display.set_caption("NGV | IMU | C:Cam | V:MapTop | Q:Manual | R:Reverse | ESC Quit")
    ...
    try:
        ...
        while True:
            ...
            if follow_enabled and spectator is not None and is_alive(ego_vehicle):
                spectator.set_transform(spectator_follow_tf(
                    ego_vehicle.get_transform(),
                    SPECTATOR_MODES[cam_mode_idx],
                    SPEC_CFG
                ))
