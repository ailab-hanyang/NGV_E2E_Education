#!/usr/bin/env python3
#======================================================================#
# Module:      NGV_SensorPractice_3_semanticcam.py
# Description: Sensor practice - Semantic segmentation visualization (pygame)
#
...
def main():
    ...
    pygame.display.set_caption("NGV | SEMANTIC | C:Cam | V:MapTop | Q:Manual | R:Reverse | ESC Quit")
